...
height:100vh;">
  ...
  <h3 style="text-align:center; padding-top: 100px;color: #08f13eff;font-size:50px">ВХОД В АДМИНИСТРАТИВНУЮ ПАНЕЛЬ</h3>
  ...
  <form style="text-align:center;padding-top: 30px;" action="./lib/login.php" method="post">
    ...
    <input class="btn" type="submit" name="login-btn" value="Войти">
