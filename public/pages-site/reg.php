...
min-height:100vh;">
  ...
  <form class="reg__form" style="text-align:center;padding-top: 10px;" action="./lib/reg.php" method="post">
    ...
    <input class="btn" type="submit" name="reg-btn" value="Зарегистрироваться">
      <a style="color: #0905f0ff;  text-decoration: none;" href="/logout.php" class="inp btn-logout">Выйти</a>
  </form>
